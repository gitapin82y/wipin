...
@section('title', 'Jasa Desain Kaos Murah Berkualitas')

@section('meta_description', 'Jasa desain kaos murah berkualitas mampu memenuhi keinginan atau kebutuhan desain kaos untuk bisnis maupun personal')

@section('meta_keywords', 'jasa desain kaos, jasa desain kaos murah, jasa desain kaos murah berkualitas, desain kaos untuk bisnis, wipin')
...
@section('meta_og_title', 'Jasa Desain Kaos Murah Berkualitas')

@section('meta_og_site_name', 'Wipin')

@section('meta_og_url', 'https://wipinweb.com/jasa-desain-kaos')

@section('meta_og_description', 'Jasa desain kaos murah berkualitas mampu memenuhi keinginan atau kebutuhan desain kaos untuk bisnis maupun personal')

@section('meta_twitter_card', 'summary')

@section('meta_twitter_site', '@WipinTeknologi')

@section('meta_twitter_title', 'Jasa Desain Kaos Murah Berkualitas')

@section('meta_twitter_description', 'Jasa desain kaos murah berkualitas mampu memenuhi keinginan atau kebutuhan desain kaos untuk bisnis maupun personal')
    ...
    <div class="row">
      <div class="col-12 col-lg-6 align-self-center">
        <div class="col-12 main-header pt-2 text-center text-lg-start">
          <h1 class="title">
            Jasa Desain
            <span class="gradient">Kaos</span> Murah Berkualitas
          </h1>
          <p class="mt-4 mb-5">Jasa desain kaos murah berkualitas mampu memenuhi keinginan atau kebutuhan desain kaos untuk bisnis maupun personal</p>
      ...
      <div class="col-12 col-lg-6 p-0">
        <img src="{{asset('assets/images/desain-grafis-detail.png')}}" width="811" height="749" class="headerImage" alt="jasa Desain Kaos" />
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="text-center mb-4">
        ...
        <h2 class="mt-1">
          Jasa Desain Kaos Harga Kaki Lima<br>
    ...
    <div class="row justify-content-center">
      <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
        ...
        <a href="
        https://api.whatsapp.com/send?phone=6285198330157&text=Halo%20Admin%20Saya%20Mau%20Order%20Jasa%20Desain%20Kaos%20Paket%20A
      ...
      <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
        ...
        <a href="
        https://api.whatsapp.com/send?phone=6285198330157&text=Halo%20Admin%20Saya%20Mau%20Order%20Jasa%20Desain%20Kaos%20Paket%20B
      " class="btn-main mt-4" target="_blank">Pesan Sekarang</a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row col-12 m-0">
      <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
        ...
        <h2 class="mt-1">
          Desain Kaos Proses<br /> Cepat Kualitas Premium
        </h2>
      ...
      <div class="col-md-6 col-12" data-aos="fade-up-left">
        <div class="card-item section-dark-color1">
          ...
          <p>
            Konsultasi mengenai kebutuhan kaos dan keinginan desain anda
          </p>
        </div>
        <div class="card-item section-dark-color1">
          <h3>Pembayaran</h3>
          <p>
            Kaos akan kami proses setelah pembayaran selesai ada 2 metode pembayaran DP 30% atau full payment 
          </p>
        </div>
        <div class="card-item section-dark-color1">
          <h3>Desain Proses</h3>
          <p>
            Desain kaos anda akan kami proses sesuai dengan konsep desain
          </p>
        </div>
        <div class="card-item section-dark-color1">
          <h3>Final Desain</h3>
  ...
  <div class="container section-dark-color">
    <div class="row">
      <div class="text-center text-md-start mb-5">
        ...
        <h2 class="mt-1">
          Klien Sangat Puas Dengan<br />Hasil Desain Kaos
        </h2>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="text-center mb-3">
        ...
        <h2 class="mt-1">
          Pertanyaan Umum <br> Mengenai Jasa Desain Kaos
        </h2>
      </div>
    </div>
    <div class="row justify-content-center">
