...
@section('title', 'Jasa Desain Logo Murah Berkualitas')

@section('meta_description', 'Jasa desain logo murah berkualitas mampu memenuhi keinginan atau kebutuhan desain logo untuk bisnis maupun personal')

@section('meta_keywords', 'jasa desain logo, jasa desain logo murah, jasa desain logo murah berkualitas, desain logo untuk bisnis, wipin')
...
@section('meta_og_title', 'Jasa Desain Logo Murah Berkualitas')

@section('meta_og_site_name', 'Wipin')

@section('meta_og_url', 'https://wipinweb.com/jasa-desain-logo')

@section('meta_og_description', 'Jasa desain logo murah berkualitas mampu memenuhi keinginan atau kebutuhan desain logo untuk bisnis maupun personal')

@section('meta_twitter_card', 'summary')

@section('meta_twitter_site', '@WipinTeknologi')

@section('meta_twitter_title', 'Jasa Desain Logo Murah Berkualitas')

@section('meta_twitter_description', 'Jasa desain logo murah berkualitas mampu memenuhi keinginan atau kebutuhan desain logo untuk bisnis maupun personal')
    ...
    <div class="row">
      <div class="col-12 col-lg-6 align-self-center">
        <div class="col-12 main-header pt-2 text-center text-lg-start">
          <h1 class="title">
            Jasa Desain
            <span class="gradient">Logo</span> Murah Berkualitas
          </h1>
          <p class="mt-4 mb-5">
            Jasa desain logo murah berkualitas mampu memenuhi keinginan atau kebutuhan desain logo untuk bisnis maupun personal
          </p>
      ...
      <div class="col-12 col-lg-6 p-0">
        <img src="{{asset('assets/images/desain-grafis-detail.png')}}" width="811" height="749" class="headerImage" alt="jasa Desain Logo" />
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="text-center mb-4">
        ...
        <h2 class="mt-1">
          Jasa Desain Logo Harga Kaki Lima<br>
    ...
    <div class="row justify-content-center">
      <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
        ...
        <ul class="p-0">
        <li><img src="{{asset('assets/icons/tick.svg')}}" class="me-2" alt="centang">Logo 1 Pilihan</li>
        ...
        <li><img src="{{asset('assets/icons/cross.svg')}}" class="me-2" alt="silang">Logo Filosofi</li>
        </ul>
        <a href="
        https://api.whatsapp.com/send?phone=6285198330157&text=Halo%20Admin%20Saya%20Mau%20Order%20Jasa%20Desain%20Logo%20Paket%20A
      ...
      <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
        ...
        <ul class="p-0">
        <li><img src="{{asset('assets/icons/tick.svg')}}" class="me-2" alt="centang">Logo 2 Pilihan</li>
        ...
        <li><img src="{{asset('assets/icons/tick.svg')}}" class="me-2" alt="centang">Export JPG / PNG</li>
        <li><img src="{{asset('assets/icons/tick.svg')}}" class="me-2" alt="centang">Logo Filosofi</li>
        </ul>
        <a href="
        https://api.whatsapp.com/send?phone=6285198330157&text=Halo%20Admin%20Saya%20Mau%20Order%20Jasa%20Desain%20Logo%20Paket%20B
      " class="btn-main mt-4" target="_blank">Pesan Sekarang</a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row col-12 m-0">
      <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
        ...
        <h2 class="mt-1">
          Desain Logo Proses<br /> Cepat Kualitas Premium
        </h2>
      ...
      <div class="col-md-6 col-12" data-aos="fade-up-left">
        <div class="card-item section-dark-color1">
          <h3>Logo Konsultasi</h3>
          <p>
            Konsultasi mengenai kebutuhan logo dan keinginan logo anda
          </p>
        </div>
        <div class="card-item section-dark-color1">
          <h3>Pembayaran</h3>
          <p>
            Logo akan kami proses setelah pembayaran selesai ada 2 metode pembayaran DP 30% atau full payment 
          </p>
        </div>
        <div class="card-item section-dark-color1">
          <h3>Logo Proses</h3>
          <p>
            Desain logo anda akan kami proses sesuai dengan konsep logo
          </p>
        </div>
        <div class="card-item section-dark-color1">
          <h3>Final Desain</h3>
          <p>
            Anda dapat melakukan permintaan revisi logo sesuai dengan batas revisi paket desain yang anda pilih
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="container section-dark-color">
    <div class="row">
      <div class="text-center text-md-start mb-5">
        ...
        <h2 class="mt-1">
          Klien Sangat Puas Dengan<br />Hasil Desain Logo
        </h2>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="text-center mb-3">
        ...
        <h2 class="mt-1">
          Pertanyaan Umum <br> Mengenai Jasa Desain Logo
        </h2>
      </div>
    </div>
    <div class="row justify-content-center">
