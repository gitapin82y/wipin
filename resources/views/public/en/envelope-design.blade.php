...
@section('title', 'Affordable Quality Envelope Design Services')

@section('meta_description', 'Affordable quality envelope design services able to meet your business or personal envelope design needs and requirements')

@section('meta_keywords', 'envelope design services, affordable envelope design, affordable quality envelope design, business envelope design, wipin')
...
@section('meta_og_url', 'https://wipinweb.com/envelope-design-services')

@section('meta_og_description', 'Affordable quality envelope design services able to meet your business or personal envelope design needs and requirements')
...
@section('meta_twitter_description', 'Affordable quality envelope design services able to meet your business or personal envelope design needs and requirements')
      ...
      <div class="row">
        <div class="col-12 col-lg-6 align-self-center">
          <div class="col-12 main-header pt-2 text-center text-lg-start">
            <h1 class="title">
              Affordable
              <span class="gradient">Envelope Design</span> Services
            </h1>
            <p class="mt-4 mb-5">Affordable quality envelope design services able to meet your business or personal envelope design needs and requirements</p>
        ...
        <div class="col-12 col-lg-6 p-0">
          <img src="{{asset('assets/images/desain-grafis-detail.png')}}" width="811" height="749" class="headerImage" alt="Envelope Design Services" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center mb-4">
          ...
          <h2 class="mt-1">
            Envelope Design Services at Street Prices<br>
      ...
      <div class="row justify-content-center">
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <a href="
          https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Envelope%20Design%20Services%20Package%20A
        ...
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <a href="
          https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Envelope%20Design%20Services%20Package%20B
        " class="btn-main mt-4" target="_blank">Order Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row col-12 m-0">
        <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
          ...
          <h2 class="mt-1">
            Envelope Design with Fast Process<br /> and Premium Quality
          </h2>
        ...
        <div class="col-md-6 col-12" data-aos="fade-up-left">
          <div class="card-item section-dark-color1">
            ...
            <p>
              Consultation regarding your envelope needs and design requirements
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Payment</h3>
            <p>
              We will process your envelope after payment is completed. There are 2 payment methods: 30% deposit or full payment
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Design Process</h3>
            <p>
              We will process your envelope design according to the design concept
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Final Design</h3>
    ...
    <div class="container section-dark-color">
      <div class="row">
        <div class="text-center text-md-start mb-5">
          ...
          <h2 class="mt-1">
            Clients Are Very Satisfied<br />With Envelope Design Results
          </h2>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center mb-3">
          ...
          <h2 class="mt-1">
            Common Questions <br> About Envelope Design Services
          </h2>
        </div>
      </div>
      <div class="row justify-content-center">
