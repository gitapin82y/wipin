...
@section('title', 'Affordable Quality Poster Design Services - Wipin')

@section('meta_description', 'Professional poster design services at affordable prices. Our designs can meet all your business or personal poster design needs and requirements.')

@section('meta_keywords', 'poster design services, affordable poster design, quality poster design, business poster design, wipin')
...
@section('meta_og_title', 'Affordable Quality Poster Design Services')

@section('meta_og_site_name', 'Wipin')

@section('meta_og_url', 'https://wipinweb.com/en/poster-design')

@section('meta_og_description', 'Professional poster design services at affordable prices. Our designs can meet all your business or personal poster design needs and requirements.')

@section('meta_twitter_card', 'summary')

@section('meta_twitter_site', '@WipinTeknologi')

@section('meta_twitter_title', 'Affordable Quality Poster Design Services')

@section('meta_twitter_description', 'Professional poster design services at affordable prices. Our designs can meet all your business or personal poster design needs and requirements.')
      ...
      <div class="row">
        <div class="col-12 col-lg-6 align-self-center">
          <div class="col-12 main-header pt-2 text-center text-lg-start">
            <h1 class="title">
              Professional
              <span class="gradient">Poster Design</span> Services
            </h1>
            <p class="mt-4 mb-5">Professional poster design services at affordable prices. Our designs can meet all your business or personal poster design needs and requirements.</p>
        ...
        <div class="col-12 col-lg-6 p-0">
          <img src="{{ asset('assets/images/desain-grafis-detail.png') }}" width="811" height="749" class="headerImage" alt="Poster Design Services" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <a href="https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Poster%20Design%20Package%20A" class="btn-main mt-4" target="_blank">Order Now</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <a href="https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Poster%20Design%20Package%20B" class="btn-main mt-4" target="_blank">Order Now</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row col-12 m-0">
        <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
          ...
          <h2 class="mt-1">
            Poster Design Process<br /> Fast Process, Premium Quality
          </h2>
        ...
        <div class="col-md-6 col-12" data-aos="fade-up-left">
          <div class="card-item section-dark-color1">
            ...
            <p>
              Consultation regarding your poster needs and design preferences
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Payment</h3>
            <p>
              We will process your poster design after payment is complete. We offer two payment methods: 30% deposit or full payment 
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Design Process</h3>
            <p>
              Your poster design will be processed according to the design concept
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Final Design</h3>
    ...
    <div class="container section-dark-color">
      <div class="row">
        <div class="text-center text-md-start mb-5">
          ...
          <h2 class="mt-1">
            Clients Are Very Satisfied With<br />Our Poster Design Results
          </h2>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center mb-3">
          ...
          <h2 class="mt-1">
            Frequently Asked Questions <br> About Poster Design Services
          </h2>
        </div>
      </div>
      <div class="row justify-content-center">
