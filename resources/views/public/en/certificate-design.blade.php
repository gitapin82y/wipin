...
@section('title', 'Affordable Quality Certificate Design Services - Wipin')

@section('meta_description', 'Professional certificate design services at affordable prices. Our designs can meet all your business or personal certificate design needs and requirements.')

@section('meta_keywords', 'certificate design services, affordable certificate design, quality certificate design, business certificate design, wipin')
...
@section('meta_og_title', 'Affordable Quality Certificate Design Services')

@section('meta_og_site_name', 'Wipin')

@section('meta_og_url', 'https://wipinweb.com/en/certificate-design')

@section('meta_og_description', 'Professional certificate design services at affordable prices. Our designs can meet all your business or personal certificate design needs and requirements.')

@section('meta_twitter_card', 'summary')

@section('meta_twitter_site', '@WipinTeknologi')

@section('meta_twitter_title', 'Affordable Quality Certificate Design Services')

@section('meta_twitter_description', 'Professional certificate design services at affordable prices. Our designs can meet all your business or personal certificate design needs and requirements.')
      ...
      <div class="row">
        <div class="col-12 col-lg-6 align-self-center">
          <div class="col-12 main-header pt-2 text-center text-lg-start">
            <h1 class="title">
              Professional
              <span class="gradient">Certificate Design</span> Services
            </h1>
            <p class="mt-4 mb-5">Professional certificate design services at affordable prices. Our designs can meet all your business or personal certificate design needs and requirements.</p>
        ...
        <div class="col-12 col-lg-6 p-0">
          <img src="{{ asset('assets/images/desain-grafis-detail.png') }}" width="811" height="749" class="headerImage" alt="Certificate Design Services" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center mb-4">
          ...
          <h2 class="mt-1">
            Certificate Design Services<br>
      ...
      <div class="row justify-content-center">
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <ul class="p-0">
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">1 Design Concept</li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">2 Revisions <small class="fw-light">(1 minor & 1 major)</small></li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">1-2 Days Delivery</li>
          <li><img src="{{ asset('assets/icons/cross.svg') }}" class="me-2" alt="cross">Source File CDR/AI</li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">Export JPG / PNG</li>
          </ul>
          <a href="https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Certificate%20Design%20Package%20A" class="btn-main mt-4" target="_blank">Order Now</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <ul class="p-0">
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">2 Design Concepts</li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">3 Revisions <small class="fw-light">(2 minor & 1 major)</small></li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">1-2 Days Delivery</li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">Source File CDR/AI</li>
          <li><img src="{{ asset('assets/icons/tick.svg') }}" class="me-2" alt="check">Export JPG / PNG</li>
          </ul>
          <a href="https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Certificate%20Design%20Package%20B" class="btn-main mt-4" target="_blank">Order Now</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row col-12 m-0">
        <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
          ...
          <h2 class="mt-1">
            Certificate Design Process<br /> Fast Process, Premium Quality
          </h2>
        ...
        <div class="col-md-6 col-12" data-aos="fade-up-left">
          <div class="card-item section-dark-color1">
            ...
            <p>
              Consultation regarding your certificate needs and design preferences
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Payment</h3>
            <p>
              We will process your certificate after payment is complete. We offer two payment methods: 30% deposit or full payment 
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Design Process</h3>
            <p>
              Your certificate design will be processed according to the design concept
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Final Design</h3>
            <p>
              You can request design revisions according to the revision limit of your chosen design package
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container section-dark-color">
      <div class="row">
        <div class="text-center text-md-start mb-5">
          ...
          <h2 class="mt-1">
            Clients Are Very Satisfied With<br />Our Certificate Design Results
          </h2>
        </div>
      </div>
      <div class="row owl-carousel owl-theme">
        ...
        <div class="card-item section-dark-color1 item">
          ...
          <div class="row pt-4">
            <p>
              Thank you for providing the best quality design for my business, Wipin is truly the best!
            </p>
            <img src="{{ asset('assets/icons/stars.svg') }}" width="300" height="100" class="star" alt="wipin testimonial review" />
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center mb-3">
          ...
          <h2 class="mt-1">
            Frequently Asked Questions <br> About Certificate Design Services
          </h2>
        </div>
      </div>
      <div class="row justify-content-center">
