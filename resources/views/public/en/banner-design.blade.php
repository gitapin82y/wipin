...
@section('title', 'Affordable Quality Banner Design Services')

@section('meta_description', 'Affordable quality banner design services able to meet your business or personal banner design needs and requirements')

@section('meta_keywords', 'banner design services, affordable banner design, affordable quality banner design, business banner design, wipin')
...
@section('meta_og_url', 'https://wipinweb.com/banner-design-services')

@section('meta_og_description', 'Affordable quality banner design services able to meet your business or personal banner design needs and requirements')
...
@section('meta_twitter_description', 'Affordable quality banner design services able to meet your business or personal banner design needs and requirements')
      ...
      <div class="row">
        <div class="col-12 col-lg-6 align-self-center">
          <div class="col-12 main-header pt-2 text-center text-lg-start">
            ...
            <p class="mt-4 mb-5">Affordable quality banner design services able to meet your business or personal banner design needs and requirements</p>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center mb-4">
          ...
          <h2 class="mt-1">
            Banner Design Services at Street Prices<br>
      ...
      <div class="row justify-content-center">
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <a href="
          https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Banner%20Design%20Services%20Package%20A
        ...
        <div class="card-item section-dark-color1 col-12 col-md-5" data-aos="fade-up">
          ...
          <a href="
          https://api.whatsapp.com/send?phone=6285198330157&text=Hello%20Admin%20I%20Want%20To%20Order%20Banner%20Design%20Services%20Package%20B
        " class="btn-main mt-4" target="_blank">Order Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row col-12 m-0">
        <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
          ...
          <h2 class="mt-1">
            Banner Design with Fast Process<br /> and Premium Quality
          </h2>
        ...
        <div class="col-md-6 col-12" data-aos="fade-up-left">
          <div class="card-item section-dark-color1">
            ...
            <p>
              Consultation regarding your banner needs and design requirements
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Payment</h3>
            <p>
              We will process your banner after payment is completed. There are 2 payment methods: 30% deposit or full payment
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Design Process</h3>
            <p>
              We will process your banner design according to the design concept
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Final Design</h3>
    ...
    <div class="container section-dark-color">
      <div class="row">
        <div class="text-center text-md-start mb-5">
          ...
          <h2 class="mt-1">
            Clients Are Very Satisfied<br />With Banner Design Results
          </h2>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center mb-3">
          ...
          <h2 class="mt-1">
            Common Questions <br> About Banner Design Services
          </h2>
        </div>
      </div>
      <div class="row justify-content-center">
