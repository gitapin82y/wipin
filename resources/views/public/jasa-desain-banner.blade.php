...
@section('title', 'Jasa Desain Banner Murah Berkualitas')

@section('meta_description', 'Jasa desain banner murah berkualitas mampu memenuhi keinginan atau kebutuhan desain banner untuk bisnis maupun personal')

@section('meta_keywords', 'jasa desain banner, jasa desain banner murah, jasa desain banner murah berkualitas, desain banner untuk bisnis, wipin')
...
@section('meta_og_title', 'Jasa Desain Banner Murah Berkualitas')

@section('meta_og_site_name', 'Wipin')

@section('meta_og_url', 'https://wipinweb.com/jasa-desain-banner')

@section('meta_og_description', 'Jasa desain banner murah berkualitas mampu memenuhi keinginan atau kebutuhan desain banner untuk bisnis maupun personal')

@section('meta_twitter_card', 'summary')

@section('meta_twitter_site', '@WipinTeknologi')

@section('meta_twitter_title', 'Jasa Desain Banner Murah Berkualitas')

@section('meta_twitter_description', 'Jasa desain banner murah berkualitas mampu memenuhi keinginan atau kebutuhan desain banner untuk bisnis maupun personal')
      ...
      <div class="row">
        <div class="col-12 col-lg-6 align-self-center">
          <div class="col-12 main-header pt-2 text-center text-lg-start">
            <h1 class="title">
              Jasa Desain
              <span class="gradient">Banner</span> Murah Berkualitas
            </h1>
            <p class="mt-4 mb-5">Jasa desain banner murah berkualitas mampu memenuhi keinginan atau kebutuhan desain banner untuk bisnis maupun personal</p>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center mb-4">
          ...
          <h2 class="mt-1">
            Jasa Desain Banner Harga Kaki Lima<br>
    ...
    <div class="container">
      ...
      <div class="row col-12 m-0">
        <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
          ...
          <h2 class="mt-1">
            Desain Banner Proses<br /> Cepat Kualitas Premium
          </h2>
        ...
        <div class="col-md-6 col-12" data-aos="fade-up-left">
          <div class="card-item section-dark-color1">
            ...
            <p>
              Konsultasi mengenai kebutuhan banner dan keinginan desain anda
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Pembayaran</h3>
            <p>
              Banner akan kami proses setelah pembayaran selesai ada 2 metode pembayaran DP 30% atau full payment 
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Desain Proses</h3>
            <p>
              Desain banner anda akan kami proses sesuai dengan konsep desain
            </p>
          </div>
          <div class="card-item section-dark-color1">
            <h3>Final Desain</h3>
    ...
    <div class="container section-dark-color">
      <div class="row">
        <div class="text-center text-md-start mb-5">
          ...
          <h2 class="mt-1">
            Klien Sangat Puas Dengan<br />Hasil Desain Banner
          </h2>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center mb-3">
          ...
          <h2 class="mt-1">
            Pertanyaan Umum <br> Mengenai Jasa Desain Banner
          </h2>
        </div>
      </div>
      <div class="row justify-content-center">
