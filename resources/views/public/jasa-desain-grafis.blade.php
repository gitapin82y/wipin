...
@section('title', 'Jasa Desain Grafis Murah Berkualitas - Wipin')

@section('meta_description', 'Jasa desain grafis murah berkualitas mulai dari desain logo, desain banner, desain poster dan masih banyak lagi mampu memenuhi kebutuhan bisnis anda')

@section('meta_keywords', 'wipin, jasa desain grafis, jasa desain grafis murah, jasa desain grafis murah berkualitas')
...
@section('meta_og_title', 'Jasa Desain Grafis Murah Berkualitas - Wipin')

@section('meta_og_site_name', 'Wipin')

@section('meta_og_url', 'https://wipinweb.com/jasa-desain-grafis')

@section('meta_og_description', 'Jasa desain grafis murah berkualitas mulai dari desain logo, desain banner, desain poster dan masih banyak lagi mampu memenuhi kebutuhan bisnis anda')

@section('meta_twitter_card', 'summary')

@section('meta_twitter_site', '@WipinTeknologi')

@section('meta_twitter_title', 'Jasa Desain Grafis Murah Berkualitas - Wipin')

@section('meta_twitter_description', 'Jasa desain grafis murah berkualitas mulai dari desain logo, desain banner, desain poster dan masih banyak lagi mampu memenuhi kebutuhan bisnis anda')
      ...
      <div class="row">
        <div class="col-12 col-lg-6 align-self-center">
          <div class="col-12 main-header pt-2 text-center text-lg-start">
            <h1 class="title">
              Jasa Desain
              <span class="gradient">Desain Grafis</span> Murah Berkualitas
            </h1>
            <p class="mt-4 mb-5">
              Jasa desain grafis murah berkualitas mulai dari desain logo, desain banner, desain poster dan masih banyak lagi mampu memenuhi kebutuhan bisnis anda
            </p>
    ...
    <div class="container">
      ...
      <div class="row col-12 m-0">
        <div class="col-md-6 col-12 mt-4 text-center text-md-start" data-aos="fade-up-right">
          ...
          <h2 class="mt-1">
            Mengapa Harus Menggunakan<br />Jasa Desain Grafis di Wipin?
          </h2>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center mb-4">
          ...
          <h2 class="mt-1">
            Jasa Desain Grafis Harga Kaki Lima<br>
      ...
      <div class="row justify-content-center">
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          <h3>Desain Logo</h3>
          <p class="fw-bold mt-3 mb-0">Dimulai dari</p>
          <p><span>Rp 200,000</span></p>
          
          <a href="jasa-desain-logo#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          <h3>Desain Banner</h3>
          <p class="fw-bold mt-3 mb-0">Dimulai dari</p>
          ...
          <a href="jasa-desain-banner#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          ...
          <a href="jasa-desain-kemasan#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          <h3>Desain Poster</h3>
          <p class="fw-bold mt-3 mb-0">Dimulai dari</p>
          ...
          <a href="jasa-desain-poster#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          <h3>Desain Kaos</h3>
          <p class="fw-bold mt-3 mb-0">Dimulai dari</p>
          ...
          <a href="jasa-desain-kaos#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          <h3>Desain Brosur</h3>
          <p class="fw-bold mt-3 mb-0">Dimulai dari</p>
          ...
          <a href="jasa-desain-brosur#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          ...
          <a href="jasa-desain-sertifikat#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        ...
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          ...
          <a href="jasa-desain-feed-ig#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
        ...
        <div class="card-item section-dark-color1 col-12 col-md-3" data-aos="fade-up">
          ...
          <a href="jasa-desain-amplop#pricelist" class="btn-main mt-4">Lebih Detail</a>
        </div>
    ...
    <div class="container section-dark-color">
      ...
      <div class="row owl-carousel owl-theme">
        ...
        <div class="card-item  section-dark-color1 item">
          ...
          <div class="row pt-4">
            <p>
              Makasih dah memberikan kualitas terbaik desain banner buat usaha saya, wipin memang terbaik
            </p>
            <img src="{{asset('assets/icons/stars.svg')}}" width="300" height="100" class="star" alt="review testimoni wipin" />
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="text-center mb-3">
          ...
          <h2 class="mt-1">
            Pertanyaan Umum <br> Mengenai Jasa Desain grafis
          </h2>
        </div>
      </div>
      <div class="row justify-content-center">
